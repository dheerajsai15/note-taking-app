              ...
              {spaces.map((space) => (
                <li key={space.id}>
                  <Link
                    ...
                    className="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-white/65 transition-all duration-150 hover:bg-white/7 hover:text-white"
                  >
                    <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-white/6 text-xs font-semibold text-white/50 transition-colors group-hover:bg-orange-500/15 group-hover:text-orange-300">
